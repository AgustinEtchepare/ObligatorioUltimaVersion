...
namespace ObligatorioVer1.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(OblDbContext context)
        {
            _context = context;
        }
        ...
        {
            ViewBag.TipoClienteList = new SelectList(new List<string> { "Nuevo", "Frecuente", "VIP" });
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Email,TipoCliente")] Cliente cliente)
        {
            ...
            ViewBag.TipoClienteList = new SelectList(new List<string> { "Nuevo", "Frecuente", "VIP" }, cliente.TipoCliente);
            return View(cliente);
        }
