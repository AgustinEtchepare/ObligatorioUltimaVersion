...
{
    public class PagoesAPIController : Controller
    {
        private readonly OblDbContext _context;

        public PagoesAPIController(OblDbContext context)
        {
            _context = context;
        }
        ...
        {
            var oblDbContext = _context.Pagos.Include(p => p.Reserva);
            return View(await oblDbContext.ToListAsync());
        }

        // GET: PagoesAPI/Details/5
